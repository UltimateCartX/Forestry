...
fun ConfigurationScreen(
    ...
    ConfigurationContent(
        ...
        onTextFieldInput = viewModel::setNewProjectName,
            ...
            Button(
                ...
                Text(
                    text = when (gnssConnectionState) {
                        is BluetoothConnectionState.Connected -> "GNSS Connecté"
                        is BluetoothConnectionState.Connecting -> "Connexion en cours..."
                        is BluetoothConnectionState.Error -> "Erreur de connexion"
                ...
                if (ActivityCompat.checkSelfPermission(
                    ...
                    Text(
                        text = when (gnssConnectionState) {
                            ...
                            is BluetoothConnectionState.Disconnected -> "Si vous ne trouvez pas le récepteur GNSS, vérifier que vous l'avez au préalable appairez à votre appareil"
                        },
        ...
        Card {
            Column(
                ...
                TextField(
                    ...
                    onValueChange = onTextFieldInput,
                    placeholder = {
                        Text("Nom du projet")
                    }
                )
